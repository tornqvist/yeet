 ...
 * @param {Boolean} opts.isSVG Whether the partial is an SVG node
 * @param {any} opts.key Key for partial
 */
export function Partial (strings, values, opts = {}) {
  const { isSVG = false, key = strings } = opts
